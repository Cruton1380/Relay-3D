...
**[docs/architecture/RELAY-MASTER-BUILD-PLAN.md](docs/architecture/RELAY-MASTER-BUILD-PLAN.md)** is the single definitive system specification. 336 frozen contracts, 111 top-level sections, full stage-gate architecture. Read it first.
