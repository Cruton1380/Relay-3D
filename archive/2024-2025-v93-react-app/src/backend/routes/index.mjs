...
// Add commit boundary routes (Phase 1: Constitutional Foundation)
import commitBoundaryRoutes from './commitBoundary.mjs';
import authorityRoutes from './authority.mjs';
...
// Add commit boundary routes (Phase 1: Constitutional Foundation)
router.use('/state', commitBoundaryRoutes); // /api/state/*
router.use('/dialogue', commitBoundaryRoutes); // /api/dialogue/*
router.use('/governance', commitBoundaryRoutes); // /api/governance/*
router.use('/authority', authorityRoutes); // /api/authority/*
